...
public class Edificio extends PropiedadHorizontal implements Construccion {
    ...
    public Edificio(int piso){
        super(piso);
    }
    @Override
    public int finEdad() {
        
     return 20;//throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
